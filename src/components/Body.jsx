        ...
        [
            ...
            },
            {
                info: {
                    ...
                    availability: {
                        nextCloseTime: "2024-03-31 22:30:00",
                        opened: true,
                    },
                    badges: {
                        imageBadges: [
            ...
            },
            {
                info: {
                    id: "120721",
                    name: "Chicago Pizza",
                    cloudinaryImageId: "tre1k3qdnl4lswesf346",
                    locality: "Old Rajendra Nagar",
                    ...
                    availability: {
                        nextCloseTime: "2024-04-01 06:00:00",
                        opened: true,
                    },
                    badges: {},
                    isOpen: true,
                ...
                analytics: {},
                cta: {
                    link: "https://www.swiggy.com/restaurants/chicago-pizza-old-rajendra-nagar-rajinder-nagar-delhi-120721",
                    type: "WEBLINK",
                },
            },
            {
            ...
            },
            {
                info: {
                    ...
                    availability: {
                        nextCloseTime: "2024-03-31 22:45:00",
                        opened: true,
                    },
                    badges: {
                        imageBadges: [
    ...
    return (
        <div className="body">
            ...
            onClick={() => {
                    ...
                    const filteredList=listofResturant.filter((res)=>res.info.avgRating <3
                    );
            ...
            <div className="res-container">
                {listofResturant.map((resList) => (
                    <RestaurantCard key={resList.info.id} resData={resList}></RestaurantCard>
                ))}
            </div>
        </div>
    );
